                                    ...
                                    @if (Auth::user()->level == 2)
                                        @if ($value1['menu']['master_tenants_id'] == @$tenant->id)
                                            ...
                                            <tr>
                                                ...
                                                <td align="center">
                                                    {{ number_format($menu[$value1['id_menu']]['harga']) }}
                                                </td>
                                        ...
                                        @endif
                                    @else
                                        @if (isset($filter['filter-tenant']))
                                            @if ($value1['menu']['master_tenants_id'] == @$filter['filter-tenant'])
                                                <?php
                                                $totalHarga += $value1['total'] * $value1['qty'];
                                                ?>
                                                <tr>
                                                    <td align="center">
                                                        {{ $nama_tenant[$value1['menu']['master_tenants_id']] }}
                                                    </td>
                                                    <td align="center">{{ $menu[$value1['id_menu']]['name'] }}</td>
                                                    <td align="center">
                                                        {{ number_format($menu[$value1['id_menu']]['harga']) }}
